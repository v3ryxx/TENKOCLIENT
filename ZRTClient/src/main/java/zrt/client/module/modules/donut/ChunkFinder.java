...
public class ChunkFinder extends Module {
    ...
    private final ScheduledExecutorService exec = Executors.newSingleThreadScheduledExecutor(r -> {
        Thread t = new Thread(r,"ZRT-ChunkFinder"); t.setDaemon(true); t.setPriority(3); return t;
    });
    ...
    private void render(Events.RenderWorldEvent e) {
        ...
        for (SusChunk c : results.get()) {
            ...
            Color col = new Color((int)(t*255),(int)((1-t)*255),0,180);
            ...
            if (showLabels.get()) RenderUtil.drawLabel(e.matrices, c.center, "§cBase? §7Score:"+c.score+" ("+c.blockCount+")", e.tickDelta);
        }
    }
